...
import ru.barabo.plastic.schema.gui.account.intoSwingThread
import ru.barabo.plastic.schema.gui.account.liteGroup
import ru.barabo.plastic.schema.gui.account.onlyButton
import ru.barabo.plastic.unnamed.gui.client.TabsInBook
import ru.barabo.plastic.unnamed.gui.client.saveTabs
...
private fun createFilterPanel(vars: List<Var>, storeStateBook: TabsInBook, cursorData: CursorData,
    ...
    return JPanel().apply {
        ...
        liteGroup("", varParams.size, 0).apply {
